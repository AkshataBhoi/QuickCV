    ...
    return (
        <section className="space-y-6">
            <div className="flex flex-col mb-2">
                ...
                <p className="text-sm text-muted-foreground">Your saved resumes for different job roles</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 max-h-[650px] overflow-y-auto pr-2 custom-scrollbar">
                ...
                <Link href="/dashboard/resume-builder">
                    <div className="group relative h-48 rounded-2xl border-2 border-dashed border-white/10 bg-white/5 hover:bg-white/[0.08] hover:border-primary/50 transition-all flex flex-col items-center justify-center gap-3 cursor-pointer">
                        ...
                        <span className="text-sm font-medium text-muted-foreground group-hover:text-white transition-colors">Create New Resume</span>
                    </div>
                </Link>
                    ...
                    <>
                        ...
                        {MOCK_RESUMES.length === 0 && (
                            <div className="col-span-full py-12 flex flex-col items-center justify-center text-center space-y-4">
                                ...
                                <div>
                                    <h3 className="text-lg font-medium text-white">You haven't created any resumes yet</h3>
                                    <p className="text-sm text-muted-foreground max-w-xs mx-auto mt-1">Start building your professional profile to land your dream job.</p>
                                </div>
                                <Link href="/dashboard/resume-builder">
                ...
                <div className="space-y-4">
                    <div className="flex justify-between items-start">
                        ...
                        <span className={cn(
                            ...
                            resume.status === "Completed" ? "bg-emerald-500/10 text-emerald-400 border border-emerald-500/20" : "bg-amber-500/10 text-amber-400 border border-amber-500/20"
                        )}>
                            {resume.status}
                        </span>
                    </div>
                    ...
                    <div>
                        <h3 className="text-lg font-bold text-white group-hover:text-primary transition-colors line-clamp-1 truncate">{resume.title}</h3>
